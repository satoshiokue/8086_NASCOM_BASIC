...
;nec	db	'NEC V20(uPD70108)',13,10
;	db	'It will soon be turned 8080 emulation mode.',13,10,0
;intel	db	'Intel 8088',13,10
;	db	'Sorry, It will soon be out of control',13,10,0
;natv	db	'Returned to native mode.',13,10
